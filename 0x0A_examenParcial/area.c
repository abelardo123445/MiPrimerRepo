...
int area(float volumen, float densidad, float costoAnterior)
{
    ...
    float area, radiomin, areamin, y; // en y se guarda la formula
    float gramos; // # de gramos 
    float pi = 3.1416; 
    float costo, costom2 = 2.45; // precio ya definido de el material
    ...
    float nuevo = costoAnterior - costo; // definir con todo y valor , con el fin de saber la resta.
